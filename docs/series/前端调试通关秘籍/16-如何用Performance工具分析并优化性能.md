...
![](16-如何用Performance工具分析并优化性能.assets/ca45ac441bd04db683793db8c4401a33tplv-k3u1fbpfcp-watermark.png)

过几秒点击结束。

![](16-如何用Performance工具分析并优化性能.assets/53a1671072e240c9afb445e468c03e79tplv-k3u1fbpfcp-watermark.png)

这时候界面就会展示出记录的信息：

![](16-如何用Performance工具分析并优化性能.assets/25bd01e6e0954ffaa4b15dc9bb0f9a7atplv-k3u1fbpfcp-watermark.png)
...
![](16-如何用Performance工具分析并优化性能.assets/0717d1b36fa84c4986996aa01d4fc755tplv-k3u1fbpfcp-watermark.png)

每个函数的耗时也都显示在左侧，右侧有源码地址，点击就可以跳到 Sources 对应的代码。

![](16-如何用Performance工具分析并优化性能.assets/e96d39a5639b44acbefa947e79f7e678tplv-k3u1fbpfcp-watermark.png)
...
![](16-如何用Performance工具分析并优化性能.assets/9c2ae86a348242e080d90259b5083734tplv-k3u1fbpfcp-watermark.png)
...
![](16-如何用Performance工具分析并优化性能.assets/c48972ec59e247c091ff0842eaa4923btplv-k3u1fbpfcp-watermark.png)

哇，long task 一个都没有了！

然后你还会发现 Main 线程下面多了两个 Worker 线程：

![](16-如何用Performance工具分析并优化性能.assets/d80d8487fb8d4da193aa3a6440f1f1bbtplv-k3u1fbpfcp-watermark.png)
...
![](16-如何用Performance工具分析并优化性能.assets/e0fc206691674b45bb873fa283bd7a93tplv-k3u1fbpfcp-watermark.png)
