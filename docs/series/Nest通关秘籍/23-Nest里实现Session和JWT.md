...
![](23-Nest里实现Session和JWT.assets/74f805d6f4954fba8bbf5a070e08c31etplv-k3u1fbpfcp-watermark.png)

然后用 postman 测试下：

![](23-Nest里实现Session和JWT.assets/a533a453fe45496fb61084e9409345f9tplv-k3u1fbpfcp-watermark.gif)
...
![](23-Nest里实现Session和JWT.assets/0690af4482204510857f640ec11f1b9ctplv-k3u1fbpfcp-watermark.png)
...
![](23-Nest里实现Session和JWT.assets/66c2384eacb14d4795d359f9f58f8f18tplv-k3u1fbpfcp-watermark.png)
...
![](23-Nest里实现Session和JWT.assets/2a622591c25041c2bec8b2c73630aa97tplv-k3u1fbpfcp-watermark.png)
...
![](23-Nest里实现Session和JWT.assets/f40b87a16e344006a58a29a95e3dee33tplv-k3u1fbpfcp-watermark.png)

放到请求的 header 里：

![](23-Nest里实现Session和JWT.assets/825a4a3bba2c445a80ae0df3bb2316a9tplv-k3u1fbpfcp-watermark.png)

这时候响应为 2，并且返回一个新的 token：

![](23-Nest里实现Session和JWT.assets/7a73e766c8b04e58a93d22fac74e7861tplv-k3u1fbpfcp-watermark.png)

把它复制下来放到 header 里再次请求：

![](23-Nest里实现Session和JWT.assets/65a1cd5c2144432bb077c39faf7ffe11tplv-k3u1fbpfcp-watermark.png)
...
![](23-Nest里实现Session和JWT.assets/04d7d1d5150c445a92ce331dec24ebb1tplv-k3u1fbpfcp-watermark.png)

这时候 jwtService.verify 方法就会抛异常，然后我们返回了 401 错误。

![](23-Nest里实现Session和JWT.assets/bdf2a2485c3641e7ae0c8883f3825f34tplv-k3u1fbpfcp-watermark.png)
