...
eg:   select price from `phone` whrer `name`="华为"
...
![image-20230623000051403](Node.js学习笔记.assets/image-20230623000051403.png)



#### 外键存在时更新/删除数据

![image-20230623002147826](Node.js学习笔记.assets/image-20230623002147826.png)
...
- 先查询后过滤：`select * from products, brands whrer products.id = brands.id`【但是当我们某个表没有id1的时候，数据也不会展示，这也不是我们想要的】
...
![image-20230623003419422](Node.js学习笔记.assets/image-20230623003419422.png)
...
- 其结果和这个是一样的`select * from products, brands whrer products.id = brands.id`



##### 全连接

![image-20230623003737763](Node.js学习笔记.assets/image-20230623003737763.png)



### 多对多的表结构

![image-20230623004413798](Node.js学习笔记.assets/image-20230623004413798.png)



#### 查询操作

![image-20230623004946757](Node.js学习笔记.assets/image-20230623004946757.png)

![image-20230623004957773](Node.js学习笔记.assets/image-20230623004957773.png)
...
![image-20230623102554187](Node.js学习笔记.assets/image-20230623102554187.png)
...
![image-20230623103445453](Node.js学习笔记.assets/image-20230623103445453.png)

![image-20230623103546475](Node.js学习笔记.assets/image-20230623103546475.png)
