...
- Object.assign会触发Object.definedProperty的set方法，展开运算符“...”不会触发
...
[了解闭包与内存泄漏以及垃圾回收机制 - 鲸落 (xiaojunnan.cn)](http://www.xiaojunnan.cn/closure)



### 作用域与作用域链+

[了解作用域与作用域链 - 鲸落 (xiaojunnan.cn)](http://www.xiaojunnan.cn/scope)



### 执行上下文

[js运行原理 - 鲸落 (xiaojunnan.cn)](http://www.xiaojunnan.cn/jsRunPrinciple)
...
[深拷贝与浅拷贝 - 鲸落 (xiaojunnan.cn)](http://www.xiaojunnan.cn/lightDeppCopy)



### 回流和重绘+

[浏览器输入url会发生什么 - 鲸落 (xiaojunnan.cn)](http://www.xiaojunnan.cn/inputUrlHappen#其他相关概念)



### js引擎—v8引擎的执行原理+

[js运行原理 - 鲸落 (xiaojunnan.cn)](http://www.xiaojunnan.cn/jsRunPrinciple#v8引擎执行原理)
...
[简单了解宏任务和微任务谁先执行 - 鲸落 (xiaojunnan.cn)](http://www.xiaojunnan.cn/eventLoop#什么是事件循环)
