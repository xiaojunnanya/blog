...
<view class="container">
  <view class="picture">
    <block wx:for="{{ firstData }}" wx:key="index">
      <view class="item" bindtap="information" data-id="{{item.id}}">
        <view>
    ...
    <block wx:for="{{ kepu }}" wx:key="index">
      <view class="item" bindtap="information" data-id="1002" data-_id="{{item.content_id}}" bindlongtap="longtap">
        <view>
