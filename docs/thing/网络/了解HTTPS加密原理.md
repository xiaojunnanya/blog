...
![image-20230823104910324](了解HTTPS加密原理.assets/image-20230823104910324.png)
...
简单说就是有两把密钥，通常一把叫做**公钥**、一把叫**私钥**，用公钥加密的内容必须用私钥才能解开，同样，私钥加密的内容只有公钥能解开。

![image-20230823105056041](了解HTTPS加密原理.assets/image-20230823105056041.png)

## 用非对称加密可行吗？

鉴于非对称加密的机制，我们可能会有这种思路：服务器先把公钥以明文方式传输给浏览器，之后浏览器向服务器传数据前都先用这个公钥加密好再传，这条数据的安全似乎可以保障了！**因为只有服务器有相应的私钥能解开公钥加密的数据**。

然而反过来**由服务器到浏览器的这条路怎么保障安全？**如果服务器用它的私钥加密数据传给浏览器，那么浏览器用公钥可以解密它，而这个公钥是一开始通过明文传输给浏览器的，若这个公钥被中间人劫持到了，那他也能用该公钥解密服务器传来的信息了。所以**目前似乎只能保证由浏览器向服务器传输数据的安全性**（其实仍有漏洞，下文会说），那利用这点有什么解决方案吗？
...
![image-20230823110206400](了解HTTPS加密原理.assets/image-20230823110206400.png)
...
![image-20230823110459132](了解HTTPS加密原理.assets/image-20230823110459132.png)
...
![image-20230823110626056](了解HTTPS加密原理.assets/image-20230823110626056.png)
